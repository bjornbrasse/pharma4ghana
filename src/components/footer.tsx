    ...
    <footer className="bg-ghana-green text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a
                  href="https://www.linkedin.com/company/pharma4ghana"
                  target="_blank"
          ...
          {/* Quick links */}
          <div>
            <h3 className="text-sm font-semibold text-green-200 uppercase tracking-wide mb-4">
              {t("quickLinks")}
            </h3>
            <ul className="space-y-2">
              {(
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-green-100 text-sm hover:text-ghana-gold transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
